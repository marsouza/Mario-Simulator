...
function getRandomCharacters() {
    ...
    const char1 = characters[index1];
    const char2 = characters[index2];

    const player1 = {
        NOME: char1.name,
        VELOCIDADE: char1.speed,
        MANOBRABILIDADE: char1.maneuverability,
        PODER: char1.power,
        PONTOS: 0,
    };
    ...
    const player2 = {
        NOME: char2.name,
        VELOCIDADE: char2.speed,
        MANOBRABILIDADE: char2.maneuverability,
        PODER: char2.power,
        PONTOS: 0,
    };
